	...
	render() {
		return (
            <header className={styles.Header}>
                <h1 className={styles.left} onClick={() => this.props.handleNavigation('空')}>
                    <div className={styles.caidan}>
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width='20px' x="0px" y="0px" viewBox="0 0 1000 1000" enableBackground="new 0 0 1000 1000" xmlSpace="preserve">
                ...
                </div>
                {
                    ...
                    ? 
                    <Navbar toggleNav={this.props.handleNavigation} /> 
                    : 
                    null 
                }
            </header>
